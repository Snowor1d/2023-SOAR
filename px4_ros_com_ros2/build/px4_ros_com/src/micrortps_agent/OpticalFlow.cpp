...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4efbca5a
    m_timestamp = 0;
    // m_sensor_id com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1b7cc17c
    m_sensor_id = 0;
    // m_pixel_flow_x_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@59662a0b
    m_pixel_flow_x_integral = 0.0;
    // m_pixel_flow_y_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@77fbd92c
    m_pixel_flow_y_integral = 0.0;
    // m_gyro_x_rate_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@67c27493
    m_gyro_x_rate_integral = 0.0;
    // m_gyro_y_rate_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1a482e36
    m_gyro_y_rate_integral = 0.0;
    // m_gyro_z_rate_integral com.eprosima.idl.parser.typecode.PrimitiveTypeCode@72967906
    m_gyro_z_rate_integral = 0.0;
    // m_ground_distance_m com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5b8dfcc1
    m_ground_distance_m = 0.0;
    // m_integration_timespan com.eprosima.idl.parser.typecode.PrimitiveTypeCode@2f9f7dcf
    m_integration_timespan = 0;
    // m_time_since_last_sonar_update com.eprosima.idl.parser.typecode.PrimitiveTypeCode@747ddf94
    m_time_since_last_sonar_update = 0;
    // m_frame_count_since_last_readout com.eprosima.idl.parser.typecode.PrimitiveTypeCode@35e2d654
    m_frame_count_since_last_readout = 0;
    // m_gyro_temperature com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1bd4fdd
    m_gyro_temperature = 0;
    // m_quality com.eprosima.idl.parser.typecode.PrimitiveTypeCode@55183b20
    m_quality = 0;
    // m_max_flow_rate com.eprosima.idl.parser.typecode.PrimitiveTypeCode@4f83df68
    m_max_flow_rate = 0.0;
    // m_min_ground_distance com.eprosima.idl.parser.typecode.PrimitiveTypeCode@6cf0e0ba
    m_min_ground_distance = 0.0;
    // m_max_ground_distance com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7d8995e
    m_max_ground_distance = 0.0;
    // m_mode com.eprosima.idl.parser.typecode.PrimitiveTypeCode@130d63be
    m_mode = 0;
