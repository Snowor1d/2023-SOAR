...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@5403f35f
    m_timestamp = 0;
    // m_gyro_rad com.eprosima.idl.parser.typecode.AliasTypeCode@483f6d77
    memset(&m_gyro_rad, 0, (3) * 4);
    // m_gyro_integral_dt com.eprosima.idl.parser.typecode.PrimitiveTypeCode@7e5afaa6
    m_gyro_integral_dt = 0;
    // m_accelerometer_timestamp_relative com.eprosima.idl.parser.typecode.PrimitiveTypeCode@63a12c68
    m_accelerometer_timestamp_relative = 0;
    // m_accelerometer_m_s2 com.eprosima.idl.parser.typecode.AliasTypeCode@483f6d77
    memset(&m_accelerometer_m_s2, 0, (3) * 4);
    // m_accelerometer_integral_dt com.eprosima.idl.parser.typecode.PrimitiveTypeCode@28f3b248
    m_accelerometer_integral_dt = 0;
    // m_accelerometer_clipping com.eprosima.idl.parser.typecode.PrimitiveTypeCode@1b1426f4
    m_accelerometer_clipping = 0;
    // m_accel_calibration_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@32b260fa
    m_accel_calibration_count = 0;
    // m_gyro_calibration_count com.eprosima.idl.parser.typecode.PrimitiveTypeCode@581ac8a8
