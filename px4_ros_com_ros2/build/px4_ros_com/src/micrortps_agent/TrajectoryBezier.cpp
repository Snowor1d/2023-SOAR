...
{
    // m_timestamp com.eprosima.idl.parser.typecode.PrimitiveTypeCode@27ae2fd0
    m_timestamp = 0;
    // m_position com.eprosima.idl.parser.typecode.AliasTypeCode@29176cc1
    memset(&m_position, 0, (3) * 4);
    // m_yaw com.eprosima.idl.parser.typecode.PrimitiveTypeCode@147ed70f
    m_yaw = 0.0;
    // m_delta com.eprosima.idl.parser.typecode.PrimitiveTypeCode@61dd025
    m_delta = 0.0;
